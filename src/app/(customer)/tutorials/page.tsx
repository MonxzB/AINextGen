...
export const metadata:Metadata={title:"Thư viện tutorial AI thực chiến",description:"Hướng dẫn AI từng bước: prompt engineering, automation, ChatGPT, sáng tạo nội dung và kiến thức AI nền tảng.",alternates:{canonical:"/tutorials",languages:{"vi-VN":"/tutorials",en:"/en/tutorials","x-default":"/tutorials"}},openGraph:{type:"website",url:"/tutorials",title:"Thư viện tutorial AI thực chiến | AINextGen",description:"Hướng dẫn AI từng bước, prompt thực chiến và workflow có thể áp dụng ngay."}};
