...
export function AnalyticsEngagementPanel({ data, days }: { data: EngagementAnalytics | null; days: number }) {
  ...
  const daily = data.daily.slice(0, 14);
